...
CASES = [
    ...
    ("RC送信機", _q("plastic metal", "radio remote control transmitter hobby", "controlling rc vehicles",
        ["radio remote control", "rc controller", "radio transmitter", "hobby rc"]),
        "8526.92.50.00", ["85"]),
    ("ダイキャストカー", _q("diecast metal plastic", "die-cast car scale model toy vehicle", "collectible display",
        ["die-cast car", "toy vehicle", "scale model car", "collectible car"]),
        "9503.00.00.90", ["95"]),
    ("児童書", _q("paper", "children's book illustrated book", "educational reading",
        ["children's book", "illustrated book", "textbook", "history textbook"]),
        "4901.99.00.92", ["49"]),
    ("包丁", _q("metal stainless steel", "kitchen knife chef knife", "cutting food preparation",
        ["kitchen knife", "chef knife", "kitchen and butcher knife", "cooking knife"]),
        "8211.92.20.00", ["82"]),
    ("工具ケース", _q("metal", "tool case carrying case", "long tool equipment storage",
        ["tool case", "equipment case", "carrying case", "metal case"]),
        "4202.99.50.00", ["42"]),
    ("書道アート", _q("paper", "calligraphy art print decorative", "wall hanging art",
        ["calligraphy", "art print", "wall art", "decorative art"]),
        "4911.99.80.00", ["49"]),
    ("ペットベッド", _q("textile fabric", "pet bed textile mat", "pet sleeping mat",
        ["pet bed", "pet mat", "cushion mat", "floor cushion"]),
        "6307.90.98.91", ["63", "94"]),
    ("ホビー雑誌", _q("paper", "printed magazine periodical", "reading hobby reference",
        ["printed magazine", "hobby magazine", "periodical", "publication"]),
        "4902.90.20.60", ["49"]),
    ("ナノブロック", _q("plastic", "nano block building block toy", "assembly display toy",
        ["nano block", "micro block", "building block", "block toy", "construction toy"]),
        "9503.00.00.90", ["95"]),
    ("収納ボックス", _q("plastic", "storage box organizer", "small item storage",
        ["storage box", "plastic container", "organizer", "drawer organizer"]),
        "3924.90.56.50", ["39"]),
